...
![image-20220521120213631](https://qijiayi-image.oss-cn-shenzhen.aliyuncs.com/img/202212131102039.png)
...
- Key 本身的数据量过大：一个 String类型的 Key，它的值为5 MB
- Key 中的成员数过多：一个ZSET类型的Key，它的成员数量为10,000个
- Key 中成员的数据量过大：一个 Hash类型的 Key，它的成员数量虽然只有1,000个但这些成员的Value（值）总大小为100 MB
...
![image-20220521133703245](https://qijiayi-image.oss-cn-shenzhen.aliyuncs.com/img/202212131102047.png)
...
- hash的entry数量超过500时，会使用哈希表而不是ZipList，内存占用较多
  ...
  ![image-20220521142943350](https://qijiayi-image.oss-cn-shenzhen.aliyuncs.com/img/202212131102169.png)
...
![image-20220521143458010](https://qijiayi-image.oss-cn-shenzhen.aliyuncs.com/img/202212131102180.png)

- 想要批量获取这些数据比较麻烦

##### 方案二：拆分为小的hash

将 id / 100 作为key， 将id % 100 作为field，这样每100个元素为一个Hash
<div>
<table>
	<tr style="color:red">
		<td>key</td>
...
![image-20220521144339377](https://qijiayi-image.oss-cn-shenzhen.aliyuncs.com/img/202212131102182.png)
...
![1653132410073](https://qijiayi-image.oss-cn-shenzhen.aliyuncs.com/img/202212131102565.png)
